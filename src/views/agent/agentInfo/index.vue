  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
          ...
          <el-form-item label="手机号码" prop="linkMobile">
            <el-input v-model="queryParams.linkMobile" placeholder="请输入手机号码" clearable size="small" style="width: 240px" @keyup.enter.native="handleQuery" />
          </el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAdd" v-hasPermi="['agent:user:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="success" icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate" v-hasPermi="['agent:user:edit']">修改</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="danger" icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete" v-hasPermi="['agent:user:remove']">删除</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="info" icon="el-icon-upload2" size="mini" @click="handleImport" v-hasPermi="['agent:user:import']">导入</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="warning" icon="el-icon-download" size="mini" @click="handleExport" v-hasPermi="['agent:user:export']">导出</el-button>
          </el-col>
        ...
        <el-table v-loading="loading" :data="agentList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="商户名称" align="center" prop="agtName" :show-overflow-tooltip="true" />
          <el-table-column label="商户类型" align="center" prop="agtType" :formatter="agtTypeFormat" />
          <el-table-column label="联系人" align="center" prop="linkName" :show-overflow-tooltip="true" />
          <el-table-column label="联系地址" align="center" prop="agtOfficeAddr" :show-overflow-tooltip="true" />
          <el-table-column label="手机号码" align="center" prop="linkMobile" width="120" />
          ...
          <el-table-column label="创建时间" align="center" prop="applyTime" width="160">
            <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.id == undefined" label="商户名称" prop="agtName">
              <el-input v-model="form.agtName" placeholder="请输入商户名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item v-if="form.id == undefined" label="商户编号" prop="agtPhone">
              <el-input v-model="form.agtPhone" placeholder="请输入商户编号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      agentList(this.addDateRange(this.queryParams, this.dateRange)).then(
        (response) => {
    ...
    // 商户类型字典翻译
    agtTypeFormat(row, column) {
      return this.selectDictLabel(this.agentTypeOptions, row.agtType);
    },
    // 用户状态修改
